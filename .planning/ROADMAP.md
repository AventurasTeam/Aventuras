...
Plans:
- [ ] 02-01-PLAN.md — World state mapper function, updated context types, new variable registry entries
- [ ] 02-02-PLAN.md — Pipeline wiring, template conversion, buildContextBlock deletion
...
- [ ] 03-03-PLAN.md — Gap closure: wire allSamples into TemplatePreview for structured preview rendering
...
Plans:
- [ ] 04-01-PLAN.md — Chapter mapper, pipeline wiring, template chapter rendering
- [ ] 04-02-PLAN.md — Feature instruction embedding in templates, injection removal
...
| 2. World State Context | 1/2 | In Progress|  |
| 3. Lorebook and Style | 2/3 | In Progress|  |
| 4. Chapters and Feature Instructions | 1/2 | In Progress|  |
