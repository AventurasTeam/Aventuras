...
const BASELINE_CSS =
  ':host{overflow-wrap:break-word}pre{white-space:pre-wrap}p{margin:4px 0}ol,ul{margin:4px 0}blockquote{border-left:2px solid var(--border);padding-left:8px;font-style:italic}code{font-family:var(--font-mono)}'
