...
type DecayResistanceFieldProps = {
  ...
  /** From the owning Controller's `fieldState.invalid`: out of range, or unreadable text. */
  invalid?: boolean
}

/** A chip lights only on an exact preset match — a continuous value shows none lit. */
export function DecayResistanceField({
  ...
  return (
    <View className="gap-2">
      {/* Named so a screen reader hears "Decay resistance", not bare Low / Medium / High. */}
