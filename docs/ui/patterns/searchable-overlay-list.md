...
the scroll until the sheet settles at its detent, then keeps the row
centered as the list resizes (keyboard, the sheet's own settling)
until the user drags the list or types.
