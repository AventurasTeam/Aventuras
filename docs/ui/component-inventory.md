...
| AppActionsMenu             | `components/compounds/` | App-level wrapper over `ActionsMenu` for the M1 chrome screens. Builds the `APP` core group with the Diagnostics-Hub launch entry gated on `diagnostics.enabled` (absent, not disabled, when off). Spec: [actions-menu.md](./patterns/actions-menu.md), [app-settings.md → Diagnostics](./screens/app-settings/app-settings.md#app--diagnostics).                                                                                                                                                                                                                                                                                                       |
