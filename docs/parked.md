...
#### Cross-model swap re-index E2E coverage
...
#### Staleness pill on non-open branches
...
#### Q3 dialogue signal across unbalanced quotes
...
#### Probe browse route decodes every payload
...
[Slice 3.1b](./implementation/milestones/03-memory-floor/slices/01b-embedder-lifecycle.md)
...
#### Same-tab section rank in Story Settings
...
#### Background content behind AlertDialog is not aria-hidden
...
#### text-transparent on Text on Android
...
#### Typed PipelineInputMap via declaration merging
...
#### Null-flattening asymmetry in the entity register
...
#### Duplicated desktop-Popover / phone-Sheet tier wrap
