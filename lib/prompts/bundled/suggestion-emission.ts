export const SUGGESTION_EMISSION = `After the state block, append exactly one <suggestions> block offering the reader {{ suggestionCount }} distinct options for what to do next. Each option is COMPLETE prose written as the reader's own next turn — not a description of an option, and not a question.
