...
export const RUNTIME_VARIABLES: VariableDefinition[] = [
  ...
  },
  {
    ...
    type: 'object',
    category: 'runtime',
    description: 'Current setting data for refinement (structured object)',
    required: false,
    infoFields: [
      ...
      { name: 'potentialConflicts', type: 'string[]', description: 'Potential story conflicts' },
      {
        name: 'keyLocations',
        type: 'array',
        description: 'Key locations ({name, description} objects)',
      },
    ] satisfies VariableFieldInfo[],
  },
  {
  ...
  },
  {
    ...
    type: 'object',
    category: 'runtime',
    description: 'User-provided character details for elaboration (structured object)',
    required: false,
    infoFields: [
      { name: 'name', type: 'string', description: 'Character name (empty = suggest one)' },
      { name: 'description', type: 'string', description: 'Physical description' },
      { name: 'background', type: 'string', description: 'Backstory and history' },
      { name: 'motivation', type: 'string', description: 'Goals and driving motivation' },
  ...
  },
  {
    ...
    type: 'object',
    category: 'runtime',
    description: 'Current character data for refinement (structured object)',
    required: false,
    infoFields: [
      ...
      { name: 'motivation', type: 'string', description: 'Goals and driving motivation' },
      { name: 'traits', type: 'string[]', description: 'Personality traits' },
      { name: 'appearance', type: 'string', description: 'Detailed appearance description' },
    ] satisfies VariableFieldInfo[],
  },
  {
    name: 'settingName',
  ...
  },
  {
    ...
    type: 'object',
    category: 'runtime',
    description: 'Protagonist summary for supporting character generation (structured object)',
    required: false,
    infoFields: [
      { name: 'name', type: 'string', description: 'Protagonist name' },
      { name: 'description', type: 'string', description: 'Protagonist description' },
      { name: 'motivation', type: 'string', description: 'Protagonist motivation' },
    ] satisfies VariableFieldInfo[],
  },
  {
    name: 'title',
  ...
  },
  {
    ...
    type: 'text',
    category: 'runtime',
    description: 'Setting atmosphere for wizard opening templates',
    required: false,
  },
  {
    ...
    type: 'array',
    category: 'runtime',
    description: 'Supporting characters for opening generation (structured array)',
    required: false,
    infoFields: [
      { name: 'name', type: 'string', description: 'Character name' },
      { name: 'role', type: 'string', description: 'Role (ally, antagonist, mentor, etc.)' },
  ...
  },
  {
    ...
    type: 'object',
    category: 'runtime',
    description: 'Current opening data for refinement (structured object)',
    required: false,
    infoFields: [
      ...
      { name: 'scene', type: 'string', description: 'Opening scene prose' },
      {
        ...
        type: 'object',
        description: 'Starting location ({name, description} object)',
      },
    ] satisfies VariableFieldInfo[],
  },
  {
    ...
    type: 'text',
    category: 'runtime',
    description: 'Author guidance for opening generation',
    required: false,
  },
  {
    ...
    type: 'text',
    category: 'runtime',
    description: 'Setting atmosphere for protagonist generation template',
    required: false,
  },
  {
    name: 'settingThemesText',
    type: 'text',
    category: 'runtime',
    description: 'Comma-joined setting themes for protagonist generation template',
    required: false,
  },
  {
    name: 'cardContent',
  ...
  },
  {
    ...
    type: 'array',
    category: 'runtime',
    description: 'Retrieved lorebook entries with tier metadata (or flat wizard entries)',
    required: false,
    infoFields: [
      ...
      },
      {
        name: 'hiddenInfo',
        type: 'string',
        description: 'Hidden lore shown in wizard templates (optional)',
      },
    ] satisfies VariableFieldInfo[],
  },
  {
